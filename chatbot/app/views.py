...
API_KEY = 'AIzaSyCCoIQqnwE5r7U11krgPdJjxoDaAW-jU-A'
...
search_words = {'sore', 'cough', 'fever', 'headache', 'pain', 'injury', 'illness', 'symptoms',
                ...
                'physical', 'wellness', 'nutrition', 'exercise', 'lifestyle', 'prevention', 'diabetes',
                'hypertension', 'cancer', 'depression', 'anxiety', 'stress', 'addiction', 'sleep', 'weight',
                'smoking', 'alcohol', 'drugs', 'pregnancy', 'childbirth', 'parenting', 'infant', 'child', 'adolescent',
                'adult', }
...
class ChatView(View):
    ...
    def get_bot_response(self, message):
        ...
        """
        if not any(word in message for word in search_words):
            return "I am not designed to answer that. Can you please ask a medical related question?"
        try:
